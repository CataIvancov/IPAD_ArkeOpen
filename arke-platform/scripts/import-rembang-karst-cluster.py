...
SOURCE_DATASET_NAME = "Rembang Karst Cluster"

COLLECTION_NAME = "Rembang Karst Cluster"
DATASET_NAME = "Rembang Karst Cluster"
DATASET_DESCRIPTION = (
    "Thematic dataset of sites in the Rembang karst region (Central Java, Indonesia), "
    "with detailed coordinates, dates, and archaeological information."
)
DATASET_BIBLIOGRAPHY = "From drive-sites-to-arkeogis.csv with thematic extraction and enrichment."
DATASET_SOURCE_DESCRIPTION = "Thematic cluster from drive-sites CSV with added data"
DATASET_SOURCE_RELATION = ""
DATASET_SUBJECT = "rembang; karst; central java; indonesia"
...
DATASET_CONTEXT_DESCRIPTION = "Thematic subset of karst-related sites in Rembang with excavation and survey data"
LICENSE_FALLBACK_NAME = "CC-BY-NC-ND-4.0"
COUNTRY_ID = 0
ROOT_CHRONOLOGY_ID = 970000

CSV_FILE = "data/rembang-karst-cluster.csv"
...
def main():
    ...
    for db in DATABASES:
        ...
        # delete old
        statements.append(
            f"DELETE FROM public.site WHERE id LIKE 'rembang-%';",
        )
        ...
        for site in site_map.values():
            ...
            if site["start_date1"] is not None or site["end_date1"] is not None:
                ...
                statements.append(
                    ...
                    f"VALUES ({src_id}, {range_id}, 1, false, {sql_literal(knowledge_type)}, now(), now()) "
