...
CSV_PATH = ROOT / "data" / "northern-moluccas-bellwood-chronology-en.csv"
CONTAINER = "arkeopenlocal-postgres"
DATABASES = ("arkeopen", "arkeogis")
ROOT_EDITOR = "Bellwood Northern Moluccas Chronology"
ROOT_EDITOR_URI = "https://researchspace.com/bellwood-northern-moluccas"
ROOT_DEPOSIT_URI = "https://researchspace.com/bellwood-northern-moluccas"
ROOT_CREDITS = "Regional chronological phases from Bellwood's research on Northern Moluccas (Morotai, Kayoa, Gebe, Halmahera)."
ROOT_GEOGRAPHICAL_COVERING = "Northern Moluccas"
MOLUCCAS_POLYGON = "POLYGON((126.0 -3.0,126.0 3.0,132.0 3.0,132.0 -3.0,126.0 -3.0))"
...
def build_sql(rows):
    ...
    statements.extend(
        [
            ...
            f"VALUES ({root_id}, 0, 0, {sql_literal(ROOT_CREDITS)}, true, ST_GeogFromText({sql_literal(MOLUCCAS_POLYGON)}), 'en', false, "
...
def verify(db, root_id):
    ...
    print(f"[bellwood-northern-moluccas:{db}]")
