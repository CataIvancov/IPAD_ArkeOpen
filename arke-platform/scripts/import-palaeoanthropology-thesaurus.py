...
ROOT_NAME_EN = "Human remains"
ROOT_NAME_ID = "Human remains"
CACHED_LANGS = "en,id"
ADMIN_GROUP_ID = 20

DATA_EN = Path("/Users/cataivancov/IdeaProjects/arke-platform/data/palaeoanthropology-thesaurus-en.csv")
DATA_ID = Path("/Users/cataivancov/IdeaProjects/arke-platform/data/palaeoanthropology-thesaurus-id.csv")
...
def main():
    ...
    for db in DATABASES:
        ...
        print(f"[palaeoanthropology-thesaurus:{db}] imported root='{ROOT_NAME_EN}'")
