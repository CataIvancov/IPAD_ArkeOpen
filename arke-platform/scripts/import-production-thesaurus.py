...
ROOT_NAME_EN = "Production"
ROOT_NAME_ID = "Produksi"
ROOT_NAME_FR = "Production"
CACHED_LANGS = "en,id,fr"
ADMIN_GROUP_ID = 20
ROOT_ID = 360

DATA_EN = Path("/Users/cataivancov/IdeaProjects/arke-platform/data/production-thesaurus-en.csv")
DATA_ID = Path("/Users/cataivancov/IdeaProjects/arke-platform/data/production-thesaurus-id.csv")
...
def main():
    ...
    for db in DATABASES:
        ...
        print(f"[production-thesaurus:{db}] imported root='{ROOT_NAME_EN}' (id={ROOT_ID})")
